...
<div style="bottom: 50px;top: 0px;left: 0px;right: 0px;position: absolute;">
    ...
    <!-- 一对一搜索信息弹出 -->
    <div class="modal fade" id="queryShow" data-backdrop="false" tabindex="-1" role="dialog"
    ...
    <!-- 一对一响应对话请求弹出 -->
    <div class="modal fade" id="answerShow" data-backdrop="false" tabindex="-1" role="dialog"
         aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div style="height: 166px;">
                                ...
                                <div style="height: 16px;">
                                    ...
                                    <div style="margin-left: 5px;">
                                        ...
                                        <form><input type="file" id="fileMsgForOne"
                                ...
                                <div style="height: 131px;width: 100%;">
                                    <textarea name="message"
                                              ...
                                              placeholder="请输入需要发送的内容"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- 右侧视频语音聊天展示 -->
                        <div style="width: 300px;height: 647px;float: left;">
                            ...
                            <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                                <div class="panel-body">
                                    <video style="height:250px;width:250px;margin: 0px;padding: 0px;" name="video"
                                           autoplay></video>
                                </div>
                                <div class="panel-footer" align="center">
                                    <button type="button" class="btn btn-default btn-lg btn-xs" name="openVideo"
                                            data-use="false"><i class="glyphicon glyphicon-facetime-video"></i> <span>开始视频</span>
                                    </button>
                                    <button type="button" class="btn btn-default btn-lg btn-xs" name="openAudio"
                                            data-use="false"><i class="glyphicon glyphicon-earphone"></i>
                                        <span>开始语音</span></button>
                                </div>
                            </div>
                            <!-- 远端视频框 -->
                            <div class="panel panel-default" style="margin: 0px;padding: 0px;">
    ...
    <!-- 多对多,最多五人对话框 -->
    <div class="modal fade" id="dialogForFive" data-backdrop="false" tabindex="-1" role="dialog"
         aria-labelledby="myModalLabel" aria-hidden="true" style="overflow:auto;">
                    ...
                    <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                        <div class="panel-body">
                            <div style="width:250px;float: left;margin-left: 2px;">
                                <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                                    <div class="panel-body" style="margin: 0px;padding: 0px;">
                                        <video style="width:100%;height:187px;margin: 0px;padding: 0px;" name="video"
                                               autoplay></video>
                                    </div>
                                    <div class="panel-footer" align="center">
                                        <label>本地视频</label>
                            ...
                            <div style="width:250px;float: left;margin-left: 2px;">
                                <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                                    <div class="panel-body" style="margin: 0px;padding: 0px;">
                                        <video style="width:100%;height:187px;margin: 0px;padding: 0px;" name="remote"
                                               data-remoteId="" data-name="remote1" autoplay></video>
                                    </div>
                                    <div class="panel-footer" align="center">
                            ...
                            <div style="width:250px;float: left;margin-left: 2px;">
                                <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                                    <div class="panel-body" style="margin: 0px;padding: 0px;">
                                        <video style="width:100%;height:187px;margin: 0px;padding: 0px;" name="remote"
                                               data-remoteId="" data-name="remote2" autoplay></video>
                                    </div>
                                    <div class="panel-footer" align="center">
                            ...
                            <div style="width:250px;float: left;margin-left: 2px;">
                                <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                                    <div class="panel-body" style="margin: 0px;padding: 0px;">
                                        <video style="width:100%;height:187px;margin: 0px;padding: 0px;" name="remote"
                                               data-remoteId="" data-name="remote3" autoplay></video>
                                    </div>
                                    <div class="panel-footer" align="center">
                            ...
                            <div style="width:250px;float: left;margin-left: 2px;">
                                <div class="panel panel-default" style="margin: 0px;padding: 0px;">
                                    <div class="panel-body" style="margin: 0px;padding: 0px;">
                                        <video style="width:100%;height:187px;margin: 0px;padding: 0px;" name="remote"
                                               data-remoteId="" data-name="remote4" autoplay></video>
                                    </div>
                                    <div class="panel-footer" align="center">
                        ...
                        <div class="panel-footer" align="center">
                            <button type="button" class="btn btn-default btn-lg btn-xs" name="openVideo"
                                    data-use="false"><i class="glyphicon glyphicon-facetime-video"></i>
                                <span>开始视频</span></button>
                            <button type="button" class="btn btn-default btn-lg btn-xs" name="openAudio"
                        ...
                        <div style="height: 100px;">
                            ...
                            <div style="height: 16px;">
                                ...
                                <div style="margin-left: 5px;">
                                    ...
                                    <form><input type="file" id="fileMsgForFive"
                                                 style="position:absolute;clip:rect(0 0 0 0);"></form>
                                </div>
                            </div>
                            <!-- 输入框 -->
...
<div style="position: absolute;bottom: 0px;left: 0px;right: 0px;color: #FFFFFF;height: 50px;line-height: 50px;"
     align="center">
</div>
<script src="/js/chat/websocket.js"></script>
<script src="/js/chat/webrtc.js"></script>
<script src="/js/chat/publicControl.js"></script>
<script src="/js/chat/oneControl.js"></script>
<script src="/js/chat/fiveControl.js"></script>
</body>
</html>